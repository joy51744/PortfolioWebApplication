<%@ Page Title="馬顥心 | 前端網頁作品集" Language="C#" MasterPageFile="~/Front-End/Site.Master" AutoEventWireup="true" CodeBehind="PortfolioWebForm12.aspx.cs" Inherits="PortfolioWebApplication.Front_End.PortfolioWebForm12" %>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="card">
                    <img class="card-img-top" style="height: 150px" src="../image/jquery.png"
                        alt="Card image cap">
                    <div class="card-body">
                        <p class="card-text" style="text-align: center"><a href="http://maprotgfolio.com/jQuery/.html">jQuery Portfolio - </a></p>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
