<%@ Page Title="馬顥心 | 前端網頁作品集" Language="C#" MasterPageFile="~/Front-End/Site.Master" AutoEventWireup="true" CodeBehind="PortfolioWebForm09.aspx.cs" Inherits="PortfolioWebApplication.Front_End.PortfolioWebForm09" %>
    ...
    <div class="container grid-demo">
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="card">
                    <img class="card-img-top" style="height: 150px" src="../image/sass.png"
                        alt="Card image cap">
                    <div class="card-body">
