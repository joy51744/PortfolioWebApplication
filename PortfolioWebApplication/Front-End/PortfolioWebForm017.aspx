<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PortfolioWebForm017.aspx.cs" Inherits="PortfolioWebApplication.Front_End.PortfolioWebForm017" %>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card">
                                <img class="card-img-top" style="height: 150px" src="../image/vue.jpeg"
                                    alt="Card image cap">
                                <div class="card-body">
                                    <p class="card-text" style="text-align: center"><a href="http://maprotgfolio.com/vue/.html">Vue.js Portfolio - </a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
