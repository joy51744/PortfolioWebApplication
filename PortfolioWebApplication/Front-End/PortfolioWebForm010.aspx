<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PortfolioWebForm010.aspx.cs" Inherits="PortfolioWebApplication.Front_End.PortfolioWebForm010" %>
            ...
            <div class="off-canvas-content" data-off-canvas-content>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card">
                                <img class="card-img-top" style="height: 150px" src="../image/foundation.jpg"
                                    alt="Card image cap">
                                <div class="card-body">
                                    <p class="card-text" style="text-align: center"><a href="http://maprotgfolio.com/foundation/.html">Foundation Portfolio - </a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                ...
                <div class="center">
                    <ul class="pagination">
                        ...
                        <li><a href="PortfolioWebForm011.aspx" style="background-color: #02df82">Next &raquo;</a></li>
                    </ul>
                </div>
            </div>
        </div>
